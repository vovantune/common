 ...
 * @method \TestApp\Model\Entity\TestTableFour|false save(\TestApp\Model\Entity\TestTableFour $entity, array|\ArrayAccess $options = [])
 ...
 * @method \TestApp\Model\Query\TestTableFourQuery find(string $type = "all", array|\ArrayAccess $options = [])
 * @method \TestApp\Model\Entity\TestTableFour get($primaryKey, array|\ArrayAccess $options = [])
 * @method \TestApp\Model\Entity\TestTableFour|false getEntity(\TestApp\Model\Entity\TestTableFour|int $entity, array|\ArrayAccess $options = [])
